        ...
        <div className="h-screen w-full flex" >
            <div className="h-full w-full flex content-center items-center">
                <form className="p-8 m-auto border shadow-lg h-[480px] w-[300px]" >
                    <h2 className="text-4xl text-center font-bold my-4">Hello.</h2>
                    <h3 className="text text-center font-thin my-4">Register to start collaborating right away.</h3>
                    ...
                    <button className="w-full border bg-indigo-600 text-white rounded-md p-2 hover:bg-indigo-400">SignUp</button>
                    <p className="flex justify-center my-1">Already a member?  <a href="https://www.google.com" className="underline ml-2">  Sign In</a></p>
                </form>
            </div>
